...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-screen bg-obsidian text-white flex flex-col justify-between p-6 md:p-12 overflow-hidden select-none pt-24 md:pt-32 scroll-mt-20"
    >
      ...
      <div className="z-10 hidden md:flex justify-between items-baseline w-full font-sans tracking-architect uppercase text-xs text-smoke"></div>
      ...
      <div className="z-10 max-w-5xl my-auto pt-12 pb-12">
        <div className="overflow-hidden mb-4">
          ...
          <motion.h1
            ...
            className="font-serif text-5xl sm:text-6xl md:text-8xl font-light tracking-tight leading-[0.95] md:leading-[0.9]"
          >
            Architecture{" "}
        ...
        >
          <a href="#contact" className="button-primary text-center">
            Start Your Project
          </a>
          <a href="#portfolio" className="button-secondary text-center">
            The Work
          </a>
        </motion.div>
      </div>
      ...
      <div className="z-10 flex justify-between items-end w-full text-[10px] md:text-xs font-mono text-graphite tracking-widest uppercase">
        <span className="hidden md:block">ASIL ©2026</span>
